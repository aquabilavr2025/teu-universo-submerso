...
const Alimentacao = () => {
  const { data: inventory, isLoading, isError, refetch, isFetching } = useGoogleSheet("alimentação");
      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto px-4">
          ...
          {isLoading ? (
            ...
            <p className="text-center text-muted-foreground">Nenhuma alimentação disponível de momento.</p>
          ) : (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
